                ...
                <section className="row justify-content-center">
                    ...
                    <div className="col-sm-10 col-md-6 col-lg-3">
                        <div className="card text-center" >
                            <img id="projectImg" src={expensePhoto} style={sameSize} className="card-img-top" alt="projects day scheduler home page" />
                            <div className="card-body align-content-center">
                                ...
                                <a href="https://nu-expense-tracker.herokuapp.com/" className="btn btn-secondary m-1">App</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-10 col-md-6 col-lg-3">
                        <div className="card text-center " >
                            <img id="projectImg" src={recipePhoto} style={sameSize} className="card-img-top" alt="recipe for success deployed homepage" />
                            <div className="card-body align-content-center">
                                ...
                                <a href="https://therecipeforsuccess.herokuapp.com/" className="btn btn-secondary m-1">App</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-10 col-md-6 col-lg-3">
                        <div className="card text-center" >
                            <img id="projectImg" src={noteTakerPhoto} style={sameSize} className="card-img-top" alt="note taker homepage" />
                            <div className="card-body align-content-center">
                                ...
                                <a href="https://limitless-wave-23866.herokuapp.com/" className="btn btn-secondary m-1">App</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-10 col-md-6 col-lg-3">
                        <div className="card text-center" >
                            <img id="projectImg" src={schedulerPhoto} style={sameSize} className="card-img-top" alt="projects day scheduler home page" />
                            <div className="card-body align-content-center">
                                <h5 className="card-title text-center">Day Scheduler</h5>
                                <a href="https://github.com/lindybriggs/hw5-scheduler" className="btn btn-secondary m-1">GitHub</a>
                                <a href="https://lindybriggs.github.io/hw5-scheduler/" className="btn btn-secondary m-1">App</a>
                            </div>
                        </div>
                    </div>
